<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="book.aspx.cs" Inherits="book" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadListView ID="RadListView1"  runat="server" AllowPaging="true" PageSize="12" DataSourceID="asd_main">
          ...
          <ItemTemplate>
              ...
              <div style="vertical-align:top; text-align:center; margin-bottom:15px;  width:250px;float:left; border-color:transparent" >
                <a  href='<%# "Details.aspx?page=book&ID=" + Eval("id")%>' >  
     ...
     <telerik:RadGrid runat="server" ID="RadGrid2"  AllowPaging="True" CssClass="RadGrid" ShowHeader="false" Visible="false"
                                   ...
                                   <table>
                                        <tr>
                                            ...
                                            <td style="float:left; text-align:left;border-color:transparent;vertical-align:top">
                                                 <h3><asp:Label  runat="server"  Text='<%# Eval("productname") %>' /></h3>
                                                 ...
                                                 <asp:Label ID="Label5" Text='<%#Eval("discount") %>'  runat="server"  />
                                                <asp:Label ID="Label1"  Text="%"  runat="server" Font-Bold="true"  /><br />
    ...
    <asp:SqlDataSource ID="asd_main" runat="server" 
          ...
          SelectCommand="SELECT * FROM alamaat_products where category='a3e89dd4-3239-5421-5645-95228ac0cf16' order by productname" />
</asp:Content>
