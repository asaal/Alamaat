<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="tasbeeh.aspx.cs" Inherits="tasbeeh" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <telerik:RadListView ID="RadListView1"   runat="server" AllowPaging="true" PageSize="12" DataSourceID="asd_main">        
          <ItemTemplate>
              ...
              <div style="vertical-align:top; text-align:center; margin-bottom:15px;  width:310px;float:left; border-color:transparent" >
                <a  href='<%# "Details.aspx?page=tasbeeh&id=" + Eval("id")%>' >  
                    <asp:Image runat="server" Width="75%" Height="150px"  src='<%# "ShowImage2.ashx?id=" + DataBinder.Eval(Container.DataItem, "fileid")  %>' ToolTip='<%# Eval("productname") %>' ID="Img1" />
    ...
    <asp:SqlDataSource ID="asd_main" runat="server" 
          ...
          SelectCommand="SELECT * FROM alamaat_products where category='43D89DD4-1453-2121-2235-76228CF0CF16' order by productname" />
    <br />
    <br />
